...
namespace HighlightPlus {
    ...
    public class HighlightProfileEditor : Editor {
        ...
        SerializedProperty glow, glowWidth, glowQuality, glowBlurMethod, glowOptimalBlit, glowDownsampling, glowHQColor, glowDithering, glowMagicNumber1, glowMagicNumber2, glowAnimationSpeed, glowVisibility, glowBlendMode, glowBlendPasses, glowPasses, glowIgnoreMask;
